...
storiesOf("Appointment", module)
  ...
  .add("Edit", () => <Form name="Name Here" interviewers={interviewers} interviewer={3} onSave={action("onSave")} onCancel={action("onCancel")} setInterviewer={action("setInterviewer")}/>)
